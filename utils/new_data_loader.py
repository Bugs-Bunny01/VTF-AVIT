...
class Tactile_Vision_dataset(data.Dataset):
    def __init__(self, Fruit_type = ['other'], label_encoding= {'other':'6'},
                 Tactile_scale_ratio = 0.5, Visual_scale_ratio = 0.5, video_length = 8, data_path='D:\dl\slip_dataset\Whole Dataset/training'):
    ...
    def __getitem__(self, index):  #need to be defined to let data_loader work\
        ...
        start_image = [0,3,6,9,12,15,18,19]
