...
sys.path.append("..")
from Models import timeSformer_orig_four
...
def get_model(config_data,use_gpu):
    ...
    if model_type == 'vivit_fdp_two':
        ...
        Tactile_patch_size = (12, 16)
        Visual_patch_size = (12, 16)
        in_chans = 3
        num_cls = 2 # 0 -> slippery; 1 -> safe; 2 -> damage
        emb_dim=256
        depth= 10
        num_heads= 16
        mlp_ratio= 4
